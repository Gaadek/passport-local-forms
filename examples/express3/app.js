var http = require('http')
  ...
  , util = require('util')
  , LocalStrategy = require('passport-local-forms').Strategy
  , forms = require('forms')
  , fields = forms.fields;
...
app.get('/login', function(req, res){
  res.render('login', { loginForm: loginForm, user: req.user, message: req.flash('error') });
});
...
app.post('/login', 
  passport.authenticate('local-forms', { failureRedirect: '/login', failureFlash: true }),
  function(req, res) {
    res.redirect('/');
  }
);
...
app.post('/login', function(req, res, next) {
  passport.authenticate('local-forms', function(err, user, info) {
